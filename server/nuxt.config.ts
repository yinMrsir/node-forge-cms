...
export default defineNuxtConfig({
  ...
  i18n: {
    locales: [
      ...
      { code: 'pt', name: 'Português', language: 'pt-PT' },
      { code: 'it', name: 'Italiano', language: 'it-IT' },
      { code: 'ja', name: '日本語', language: 'ja-JP' },
      { code: 'th', name: 'ภาษาไทย', language: 'th-TH' },
      ...
      { code: 'da', name: 'Dansk', language: 'da-DK' },
      { code: 'ar', name: 'العربية', language: 'ar' },
      { code: 'nb', name: 'Norsk bokmål', language: 'nb-NO' },
      { code: 'nl', name: 'Nederlands', language: 'nl-NL' },
      { code: 'id', name: 'Bahasa Indonesia', language: 'id-ID' },
      { code: 'tw', name: '繁体中文', language: 'zh-TW' },
      { code: 'zh', name: '简体中文', language: 'zh-CN' },
      { code: 'tr', name: 'Türkçe', language: 'tr-TR' },
      { code: 'hi', name: 'हिन्दी', language: 'hi-IN' },
      { code: 'bn', name: 'বাংলা', language: 'bn' }
    ],
